...
function setPumpkins(wrapperSelector, pumpkinDivClass, pumpkinClass) {
    ...
    svgs.forEach(i => {
        ...
        i.addEventListener('click', (e)=>{
            ...
            i.style.filter = `drop-shadow( 3px 3px 2px ${color})`;
        });        

        ['mouseover', 'mousemove', 'mouseenter'].forEach(hover=>{
            i.addEventListener(hover, (e)=> {
                i.classList.remove('pumpkin__animation');
            });
        });								
        
        i.addEventListener('mouseout', (e)=> {
            i.classList.add('pumpkin__animation');
        });
    });
